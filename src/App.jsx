...
export function App(){
 ...
 <footer className="site-footer"><div><p>Bakersfield · Tehachapi · Kern County · San Diego</p><p className="footer-credentials">{agent.name} · REALTOR® · Compass · DRE #{agent.license}</p><p className="footer-credentials">Equal Housing Opportunity</p></div><SocialLinks/></footer><Analytics/></>;
}
