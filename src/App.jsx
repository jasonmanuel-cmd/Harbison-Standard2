...
export function App(){
 ...
 <footer className="site-footer"><div><p>Bakersfield · Tehachapi · Kern County · San Diego</p><p className="footer-credentials"><a href={agent.phoneHref}>{agent.phone}</a> · <a href={'mailto:'+agent.email}>{agent.email}</a></p><p className="footer-credentials">{agent.name} · REALTOR® · Harbison Standard · DRE #{agent.license}</p><p className="footer-credentials">Equal Housing Opportunity</p></div><SocialLinks/></footer>
