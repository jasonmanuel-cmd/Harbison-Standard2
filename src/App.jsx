...
export function App(){
 ...
 <footer className="site-footer"><div><p>Bakersfield · Tehachapi · Kern County · San Diego</p><p className="footer-credentials">{agent.name} · REALTOR® · Harbison Standard · DRE #{agent.license}</p><p className="footer-credentials">Equal Housing Opportunity</p></div><SocialLinks/></footer></>;
}
