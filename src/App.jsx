...
export function App({initialPath,initialProperty}={}){
 ...
 <main id="main">{Component?<Component key={path} {...(propertyMatch?{slug:decodeURIComponent(propertyMatch[1]),initialProperty}:{})}/>:<section className="page-heading page-wrap"><p className="eyebrow">404 · Page not found</p><h1>Let’s get you <em>home.</em></h1><a href="/" className="gold">Back to home <ArrowRight/></a></section>}
