...
export function BuyerIntentForm({propertyId=null,source='buyer-intent',earlyInterest=false}) {
 ...
 async function submit(e){
  ...
  try{
   const res=await fetch('/api/buyer-lead',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({...data,hasPropertyToSell:data.hasPropertyToSell==='yes',propertyId,source,...attribution})});
