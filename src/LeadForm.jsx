...
async function submit(){
 ...
 return <div className="lead-card">
  ...
  {status==='success'?<>
   ...
   <p className="form-intro">Nate will be in touch using the details you shared. You can also expect a copy at {data.email}.</p>
